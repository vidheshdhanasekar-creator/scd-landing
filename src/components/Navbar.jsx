  ...
  return (
    <>
      ...
      <nav
        ...
        style={{
          background: scrolled ? 'rgba(5,3,12,0.88)' : 'transparent',
          backdropFilter: scrolled ? 'blur(28px) saturate(180%)' : 'none',
          borderBottom: scrolled ? '1px solid rgba(139,92,246,0.10)' : 'none',
        }}
      >
        {/* Animated top line */}
        ...
        <div className="max-w-7xl mx-auto px-6 h-[68px] flex items-center justify-between">
          ...
          <a href="#" onClick={closeMobile} className="flex items-center gap-3 group flex-shrink-0">
            <div className="relative">
              <div className="absolute inset-0 rounded-full bg-purple-600/20 blur-md group-hover:bg-purple-600/40 transition-all duration-500" />
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            <a
              ...
              style={{
                ...
                boxShadow: '0 0 0 1px rgba(168,85,247,0.3), 0 4px 20px rgba(109,40,217,0.35)',
              }}
            >
